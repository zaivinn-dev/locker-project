...
const char* BACKEND_HOST = "http://192.168.2.109:5000";
const char* BACKEND_RFID_URL = "http://192.168.2.109:5000/device/rfid";
const char* BACKEND_IR_URL = "http://192.168.2.109:5000/device/ir-status";
const char* BACKEND_FINGERPRINT_URL = "http://192.168.2.109:5000/device/fingerprint";
const char* BACKEND_FINGERPRINT_ENROLL_URL = "http://192.168.2.109:5000/device/fingerprint/enroll";
const char* BACKEND_FINGERPRINT_START_ENROLL_URL = "http://192.168.2.109:5000/device/fingerprint/start-enrollment";
const char* BACKEND_SCAN_ENABLED_URL = "http://192.168.2.109:5000/api/access/scan-enabled";
